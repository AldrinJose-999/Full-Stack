...
// //   const timeSlots = ["10:00 AM", "11:45 AM", "12:35 PM", "01:25 PM", "02:10 PM", "03:00 PM", "03:50 PM" , "04:50 PM"]
...
// //         days.map((day) => [
// //           day,
// //           Object.fromEntries(timeSlots.map((time) => [time, ""]))
// //         ])
// //       )
// //   );

// //   const handleEditCell = (day, time) => {
// //     const subject = prompt(`Enter subject for ${day} at ${time}`, tableData[day][time]);
// //     if (subject !== null) {
...
// //                     <h4 class="mb-4 pb-3">TIME TABLE</h4>

// //                     <div class="table-responsive">
// //                       <table class=" timetable-block">
...
// //                                 >
// //                                   <span className=" bi-pencil-square"></span>
// //                                 </button>
// //                               )}
// //                             </td>
// //                           ))}
...
// import "./Table.css";
// import Subject from "./Subject"; // ✅ Import Subject modal component
...
//   setEditDay(day);
//   setEditTime(time);
//   setSubjectInput(tableData[day][time].subject);
//   setSubjectType(tableData[day][time].type);
//   setShowModal(true);
// };
...
//            <h1 className="mb-4 pb-3" style={{ fontFamily: "Times, serif" , color: "#fdfeffff" }}>TIME TABLE</h1>
...
//                               <div>
//                                 <button
//                                   className="table-btn btn btn-sm p-1 me-2"
//                                   onClick={() => handleDeleteCell(day, time)}
//                                 >
//                                   <i className="bi bi-trash" style={{ fontSize: "12px" }}></i>
//                                 </button>
...
//       {/* ✅ Use modal with correct variable names */}
//       <Subject
//         show={showModal}
//         day={editDay}
//         time={editTime}
